        ...
        <div class="card" style="width: 100rem;">
            ...
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item"><b>FOTO VISI : </b>{{$profil->foto_visi}}</li>
                    <li class="list-group-item"><b>MISI SEKOLAH : </b>{{$profil->misi_sekolah}}</li>
                    <li class="list-group-item"><b>FOTO MISI : </b>{{$profil->foto_misi}}</li>
                    <li class="list-group-item"><b>TUJUAN SEKOLAH : </b>{{$profil->tujuan_sekolah}}</li>
                    <li class="list-group-item"><b>FOTO TUJUAN 1 : </b>{{$profil->foto_tujuan1}}</li>
                    <li class="list-group-item"><b>FOTO TUJUAN 2 : </b>{{$profil->foto_tujuan2}}</li>
                </ul>
            </div>
